...
namespace WebNutricion.Controllers
{
    ...
    public class planAlimentacionController : Controller
    {
        ...
        {
            var planAlimentacions = db.planAlimentacions.Include(p => p.AspNetUser);
            return View(planAlimentacions.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "idPlan,desayuno,almuerzo,merienda,cena,calorias,Cedula,fecha,idUser")] planAlimentacion planAlimentacion, [Bind(Include = "idPlanificacionNutricional,peso,altura,IMC,grasacorporal,metabolismobasal,caloriasdiarias,proteinas,carbohidratos,grasas,objetivo,Cedula,fecha,idUser")] planificacionNutricional planificacionNutricional)
        {
            ...
            ViewBag.idUser = new SelectList(db.AspNetUsers, "Id", "Email", planAlimentacion.idUser);
            return View(planAlimentacion);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idPlan,desayuno,almuerzo,merienda,cena,calorias,Cedula,fecha,idUser")] planAlimentacion planAlimentacion)
        {
            if (ModelState.IsValid)
            {
