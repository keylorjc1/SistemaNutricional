...
namespace WebNutricion.Controllers
{
    public class AspNetUserController : Controller
    {
        ...
        public ActionResult ShowAntropometricData(string id)
        {
            ...
            var valorNutricionalData = db.valoresNutricionales.Where(d => d.idUser == id).OrderByDescending(d => d.fecha).FirstOrDefault();
            var planificacionNutricionalData = db.planificacionNutricionals.Where(d => d.idUser == id).OrderByDescending(d => d.fecha).FirstOrDefault();
            ...
            var viewModel = new Tuple<valoresNutricionale, planificacionNutricional, planAlimentacion>(valorNutricionalData, planificacionNutricionalData, planAlimentacionData);
